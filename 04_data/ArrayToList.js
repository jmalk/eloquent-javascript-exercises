/*
 * Eloquent JavaScript, Chapter 4 Ex 3 A list is a nested set of objects, with
 * the first object holding a reference * to the second, the second to the
 * third, and so on.  Write a function arrayToList that builds up a data
 * structure like the previous one when given [1, 2, 3] as argument, and write
 * a listToArray function that produces an array from a list.  Also write the
